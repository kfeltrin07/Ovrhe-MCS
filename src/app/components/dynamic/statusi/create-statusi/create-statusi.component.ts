...
import { CRUDAction, Statusi, Tvrtke } from 'src/app/models/models.service';
...
@Component({
  ...
  templateUrl: './create-statusi.component.html',
  styleUrl: './create-statusi.component.scss'
})
export class CreateStatusiComponent {
  public varNames: any = {
    NAZIVTVRTKE: "",
  };
  ...
  constructor(
    private dialogRef: MatDialogRef<CreateStatusiComponent>,
