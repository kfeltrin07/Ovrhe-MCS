...
import { Tvrtke, ChartOfAccounts, CRUDAction } from 'src/app/models/models.service';
...
@Component({
  ...
  templateUrl: './create-tvrtke.component.html',
  styleUrl: './create-tvrtke.component.scss'
})
export class CreateTvrtkeComponent implements OnInit {
  public varNames: any = {
    KONTOUPLATE: "",
    PROTUKONTO: "",
  };
  ...
  constructor(
    private dialogRef: MatDialogRef<CreateTvrtkeComponent>,
