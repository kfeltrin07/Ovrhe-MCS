...
@Component({
  selector: 'app-create-statusi-radnji',
  standalone: true,
  imports: [
    MatInputModule,
    MatButtonModule,
  ...
  templateUrl: './create-statusi-radnji.component.html',
  styleUrl: './create-statusi-radnji.component.scss'
})
export class CreateStatusiRadnjiComponent {
  public varNames: any = {
    NAZIVTVRTKE: "",
  };
  ...
  constructor(
    private dialogRef: MatDialogRef<CreateStatusiRadnjiComponent>,
