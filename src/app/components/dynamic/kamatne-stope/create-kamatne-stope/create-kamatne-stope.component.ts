...
import { KamatneStope, Tvrtke, CRUDAction } from 'src/app/models/models.service';
...
@Component({
  selector: 'app-create-kamatne-stope',
  standalone: true,
  imports: [
    MatInputModule,
    MatButtonModule,
  ...
  templateUrl: './create-kamatne-stope.component.html',
  styleUrl: './create-kamatne-stope.component.scss'
})
export class CreateKamatneStopeComponent {
  public varNames: any = {
    NAZIVTVRTKE: "",
  };
  ...
  constructor(
    private dialogRef: MatDialogRef<CreateKamatneStopeComponent>,
