...
@Component({
  ...
  templateUrl: './edit-tip-ovrhe.component.html',
  styleUrl: './edit-tip-ovrhe.component.scss'
})
export class EditTipOvrheComponent implements OnInit {
  public varNames: any = {
    KONTO: "",
    PROTUKONTO: "",
  };
  ...
  constructor(
    @Inject(MAT_DIALOG_DATA) public receivedTipOvrhe: TipOvrhe,
    private dialogRef: MatDialogRef<EditTipOvrheComponent>,
  ...
  public ngOnInit(): void {
    this.tipOvrhe = this.receivedTipOvrhe;
