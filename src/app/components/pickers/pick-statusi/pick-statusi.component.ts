...
import { Sorting, Statusi } from 'src/app/models/models.service';
...
@Component({
  ...
  templateUrl: './pick-statusi.component.html',
  styleUrl: './pick-statusi.component.scss'
})
export class PickStatusiComponent {
 public displayedColumns: string[] = ['RN', 'IDSTATUSA', 'NAZIVSTATUSA', 'IDTVRTKE', 'JEZATVORENO', 'AKTIVNOST'];
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<PickStatusiComponent>
  ) { }
  ...
  public pickStatusi(row: Statusi): void {
